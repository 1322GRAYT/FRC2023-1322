...
public class SwerveDrivetrain extends SubsystemBase {
    ...
    */
    ...
    public void setPose(Pose2d pose) {
        //this.swerveOdometry.resetPosition(pose, getSwerveModulePositions(), pose.getRotation());
        this.swerveOdometry.resetPosition(pose.getRotation(), getSwerveModulePositions(), pose);  
      }

    public void resetOdometry(Pose2d pose) {
        //this.swerveOdometry.resetPosition(pose, getSwerveModulePositions(), this.getYaw());
    ...
    public void periodic() {
        ...
        this.swerveOdometry.update(getYaw(), getSwerveModulePositions());
