...
public class FollowTrajectoryAndStop extends SequentialCommandGroup {
    ...
    public FollowTrajectoryAndStop(
            String trajectory, 
        ...
        addCommands(
            new SwerveControllerCommand(
                ...
                new InstantCommand(() -> {
                  _swerveSubsystem.stopSwerveDriveMotors();
                  _swerveSubsystem.stopSwerveRotateMotors();
                }))
        );
    }
